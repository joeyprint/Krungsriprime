    ...
    <div class="container marginBot80">
        <div class="row justify-content-center">
            ...
            <div class="col-11 col-sm-8 text-center margin10 d-none d-md-block">
                ...
                <p class="yellow-text hash-text" data-aos="header-up" data-aos-easing="linear">
                    # F <span class="white-text">I</span> R S T M I L L I O N
                </p>
                <p class="line text-center aos-init" data-aos="fade-center" data-aos-easing="linear"></p>
            </div>
        </div>
    </div>
</section>